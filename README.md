...
```
  Régimen BTC: ret30d=+9.8%  ret7d=+8.5%  ·  fuera de régimen de impulso  ⚠️ CACHÉ STALE (3h) — refrescar con `python -m SUPREMO.hist_extiende`
...
│ LIVE·5_posicion_rango   SHORT RANGE     158    -0.446  -70.49   39% [-0.67,-0.20]*                   │
...
│ SOMBRA·41a_a2_confirmadoLONG  RANGE     137    -0.022   -2.98   36% [-0.26,+0.22]                    │
...
│ LIVE·5_posicion_rango   SHORT (TOTAL)        243    47%  -0.068  -16.44   48%       [-0.32,+0.18]  R158 B25 Be6     │
│                               alt1d_range     69    47%  -0.969  -66.88   26%      [-1.22,-0.68]*  R66 B0 Be3   [ARMADA] │
│                               alt1d_trend     45    47%  -0.367  -16.51   36%       [-0.75,+0.05]  R41 B1 Be3       │
│                               age4h_alto      65    47%  -0.788  -51.21   28%      [-1.07,-0.44]*  R60 B1 Be4   [ARMADA] │
│                               age4h_bajo      80    47%  -0.013   -1.01   52%       [-0.35,+0.31]  R63 B16 Be1      │
│                               vol_rel_alto    64    47%  +0.274  +17.54   56%       [-0.10,+0.68]  R49 B13 Be2      │
│                               vol_rel_bajo    63    47%  -0.462  -29.08   41%      [-0.75,-0.14]*  R54 B6 Be3   [ARMADA] │
│                               btc_range      158    47%  -0.446  -70.49   39%      [-0.67,-0.20]*  R158 B0 Be0  [ARMADA] │
...
│                               celda_range_range 153    47%  -0.350  -53.61   42%      [-0.58,-0.11]*  R140 B0 Be1  [ARMADA] │
...
│ SOMBRA·41a_a2_confirmadoLONG  (TOTAL)        169   100%  +0.602 +101.71   48%      [+0.41,+0.81]*  R137 B0 Be32     │
│                               alt1d_range     86   100%  +0.379  +32.59   47%      [+0.05,+0.74]*  R71 B0 Be15  [ARMADA] │
│                               alt1d_trend     83   100%  +0.833  +69.12   49%      [+0.57,+1.13]*  R66 B0 Be17  [ARMADA] │
│                               age4h_alto      59   100%  +0.489  +28.86   49%      [+0.03,+0.97]*  R50 B0 Be9   [ARMADA] │
│                               age4h_bajo      58   100%  +1.007  +58.39   52%      [+0.58,+1.50]*  R46 B0 Be12  [ARMADA] │
│                               vol_rel_alto    58   100%  +1.546  +89.67   66%      [+1.06,+2.06]*  R45 B0 Be13  [ARMADA] │
│                               vol_rel_bajo    56   100%  -0.077   -4.34   38%       [-0.52,+0.38]  R47 B0 Be9   [ARMADA] │
│                               btc_range      137   100%  -0.022   -2.98   36%       [-0.26,+0.22]  R137 B0 Be0  [ARMADA] │
│                               btc_trend       32   100%  +3.271 +104.69  100%      [+2.98,+3.54]*  R0 B0 Be32   [pos] │
...
│ SOMBRA·s87_fib_cont_bajiSHORT (TOTAL)          1   100%  -2.017   -2.02    0%                 n/a  R0 B1 Be0        │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
==================================================================================================================================
  ...
  5_posicion_rango        alt1d_range     SHORT     categ.     47   -0.827   [-1.12,-0.50]        2         5   +72.13%   100%     [+10.14,+20.19]  R5 B0 Be0
  5_posicion_rango        age4h_alto      SHORT       57.8     54   -0.547   [-0.86,-0.18]        2         5   +80.80%   100%     [+10.96,+21.69]  R4 B1 Be0
  5_posicion_rango        btc_range       SHORT     categ.    133   -0.302   [-0.55,-0.05]        3         6   +96.58%   100%     [+11.29,+21.30]  R6 B0 Be0
  ...
  41a_a2_confirmador      alt1d_trend     LONG      categ.     48   -0.820   [-1.07,-0.50]        5        20  -155.90%     0%       [-8.93,-6.81]  R13 B0 Be7
  41a_a2_confirmador      age4h_alto      LONG       103.0     35   -0.680   [-1.03,-0.25]        2         8   -71.16%     0%      [-10.63,-7.25]  R2 B0 Be6
  41a_a2_confirmador      age4h_bajo      LONG        34.0     34   -0.998   [-1.29,-0.64]        3        24  -183.81%     0%       [-8.65,-6.76]  R16 B0 Be8
  ...
  41a_a2_confirmador      btc_range       LONG      categ.    101   -0.905   [-1.09,-0.70]        3        21  -130.17%     0%       [-6.72,-5.71]  R21 B0 Be0
